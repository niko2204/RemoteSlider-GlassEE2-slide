...
package com.uvr.slider.glass.network.fragments;
...
import com.uvr.slider.glass.network.R;
import com.uvr.slider.glass.network.menu.MenuActivity;
...
public abstract class BaseFragment extends Fragment implements OnSingleTapUpListener {
   ...
   * @param resultCode is a code set by the {@link com.uvr.slider.glass.network.menu.MenuActivity}
